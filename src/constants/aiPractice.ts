...
export const AI_PRACTICE_MENU_ITEMS: MenuItem[] = [
  {
    title: "시나리오 연습",
    description:
      "식당, 병원 등 맞춤 상황을 설정하고 3단계로 이루어진 대화를 연습하세요.",
    ...
    hoverBorderClassName:
      "hover:border-emerald-500/50 hover:shadow-[0_8px_32px_rgba(16,185,129,0.15)]",
