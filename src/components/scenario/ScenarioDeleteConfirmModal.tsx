      ...
      >
        <div className="mb-8 flex items-center justify-between">
          ...
          <button
            ...
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 disabled:cursor-not-allowed disabled:opacity-60"
            aria-label="모달 닫기"
          >
            <X size={22} />
          </button>
        ...
        <div className="flex gap-4">
          <button
            ...
            onClick={onClose}
            disabled={isSubmitting}
            className="h-[80px] flex-1 rounded-[22px] bg-[#F8F9FD] text-[18px] font-extrabold text-slate-600 transition hover:bg-slate-100 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
          >
            취소
          </button>
          <button
            ...
            onClick={onDelete}
            disabled={isSubmitting}
            className="h-[80px] flex-1 rounded-[22px] bg-rose-500 text-[18px] font-extrabold text-white shadow-[0_10px_20px_rgba(244,63,94,0.25)] transition hover:bg-rose-600 active:scale-95 disabled:cursor-not-allowed disabled:opacity-70"
          >
